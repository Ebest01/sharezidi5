"""
ShareZidi v3.0 - Simple FastAPI Server
Basic WebSocket file transfer for testing
"""
...
app = FastAPI(
    title="ShareZidi v3.0 - Simple P2P File Transfer",
    description="Basic WebSocket file transfer for testing",
    version="3.0.0"
)
...
async def root():
    return {
        "message": "ShareZidi v3.0 - Simple P2P File Transfer",
        "status": "running",
        "features": [
...
if __name__ == "__main__":
    import uvicorn
    print("🚀 Starting ShareZidi v3.0 - Simple P2P File Transfer")
    print("📱 Open http://localhost:8000/test for WebSocket testing")
